...
export const MEASURE_OPTIONS: { key: keyof NodeMeasures; label: string; unit: string }[] = [
  ...
  { key: 'stud_count', label: 'Montanți', unit: 'buc' },
  { key: 'framing_length_m', label: 'Lungime lemn (cadre)', unit: 'm' },
  { key: 'sheathing_area_m2', label: 'Arie placare (o față)', unit: 'm²' },
  { key: 'stud_length_m', label: 'Lungime montanți', unit: 'm' },
  { key: 'plate_length_m', label: 'Lungime tălpi', unit: 'm' },
  { key: 'header_length_m', label: 'Lungime buiandrugi', unit: 'm' },
  { key: 'header_count', label: 'Buiandrugi', unit: 'buc' },
  { key: 'sheathing_sheet_count', label: 'Plăci OSB (o față)', unit: 'buc' },
  { key: 'panel_count', label: 'Panouri CLT', unit: 'buc' },
  { key: 'panel_area_m2', label: 'Arie panouri CLT (brut)', unit: 'm²' },
  { key: 'cut_length_m', label: 'Lungime tăiere CNC', unit: 'm' },
  { key: 'joint_length_m', label: 'Lungime rosturi', unit: 'm' },
  { key: 'connector_count', label: 'Conectori', unit: 'buc' },
  { key: 'is_exterior', label: 'Perete exterior (1/0)', unit: '' },
  { key: 'is_interior', label: 'Perete interior (1/0)', unit: '' },
  { key: 'opening_count', label: 'Număr goluri', unit: 'buc' },
  { key: 'opening_width_m', label: 'Lățimi goluri însumate', unit: 'm' },
  { key: 'outer_perimeter_m', label: 'Perimetru contur', unit: 'm' },
  { key: 'hole_perimeter_m', label: 'Perimetru celule', unit: 'm' },
  { key: 'hole_area_m2', label: 'Arie celule', unit: 'm²' },
  { key: 'hole_count', label: 'Număr celule', unit: 'buc' },
  { key: 'net_solid_area_m2', label: 'Aria plinului', unit: 'm²' },
  { key: 'band_area_m2', label: 'Aria benzii', unit: 'm²' },
  { key: 'outer_face_area_m2', label: 'Arie fațadă', unit: 'm²' },
  { key: 'inner_face_area_m2', label: 'Arie fețe interioare', unit: 'm²' },
];
